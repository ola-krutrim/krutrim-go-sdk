...
// KRUTRIM_CLIENT_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("KRUTRIM_CLIENT_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("KRUTRIM_CLIENT_API_KEY"); ok {
...
// environment (KRUTRIM_CLIENT_API_KEY, KRUTRIM_CLIENT_BASE_URL). The option passed
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.DeleteSubnet = NewDeleteSubnetService(opts...)
	r.CreateSubnet = NewCreateSubnetService(opts...)
	r.SearchSubnet = NewSearchSubnetService(opts...)
	r.CreateVpcAsync = NewCreateVpcAsyncService(opts...)
	r.GetVpcTaskStatus = NewGetVpcTaskStatusService(opts...)
	r.SearchVpc = NewSearchVpcService(opts...)
	r.DescribeVpc = NewDescribeVpcService(opts...)
	r.DeleteVpc = NewDeleteVpcService(opts...)
	r.CreatePort = NewCreatePortService(opts...)
	r.FloatingIPList = NewFloatingIPListService(opts...)
	r.DeleteFloatingIP = NewDeleteFloatingIPService(opts...)
	r.Highlvlvpc = NewHighlvlvpcService(opts...)
	r.Vm = NewVmService(opts...)
	r.Sshkey = NewSshkeyService(opts...)
