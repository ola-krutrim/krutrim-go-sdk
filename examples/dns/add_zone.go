...
func main() {
	...
	params := krutrim.DNSV1ZoneAddParams{
		// REQUIRED FIELDS
		Type:     "private", // or "public" if supported
		Vpcid:    "Enter VPC KRN",
		Zonename: "Enter Zone name", // DNS zone name
	}

	var resp *http.Response

	// Call API
	err := client.DNS.V1.Zone.Add(ctx, params, option.WithResponseInto(&resp))
	if err != nil {
		log.Fatal(err)
	}
	...
	fmt.Printf("Zone added successfully:\n%s\n", string(responseJSON))
