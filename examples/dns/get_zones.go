...
func main() {
	...
	params := krutrim.DNSV1GetZonesParams{
		// REQUIRED FIELDS
		Region: "In-Bangalore-1", // DNS zone name
	}

	var resp *http.Response

	// Call API
	err := client.DNS.V1.GetZones(ctx, params, option.WithResponseInto(&resp))
	if err != nil {
		log.Fatal(err)
	}
	...
	fmt.Printf("Zones fetched successfully:\n%s\n", string(responseJSON))
}
