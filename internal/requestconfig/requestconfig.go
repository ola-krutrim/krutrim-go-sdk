...
func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("KrutrimClient/Go %s", internal.PackageVersion),
	}
}
...
func (cfg *RequestConfig) Execute() (err error) {
	...
	// Backend bug workaround: sometimes JSON is returned as text/plain
	if !isJSON && strings.Contains(mediaType, "text/plain") {
